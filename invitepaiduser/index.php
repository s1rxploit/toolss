...
include('../header.php');
?>
<title>Invite Code For Paid User</title>
<div id="left">
...
<div class="row">
<div class="col-lg-12">
<h1> Invite Code For Paid User </h1>
</div>
</div>
<hr />
<?php
...
<i class="icon-font"></i>
<span>Invite Code For Paid User</span>
</div>
<div class="panel-body">
<form action="/invitepaiduser/alien07.php" method="POST">
...
<?php
                    ...
                    $query = "SELECT * FROM invitecodepaid WHERE Author='$email'";
