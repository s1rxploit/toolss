...
if(isset($_POST['ue'])){
	$coc = ambil("cokie",rand_ua(),"https://www.paypal.com/xclick/business=".$_POST['ue']);
	$cocok = isset($co[$coc]) ? "[" . $coc . "] " . $co[$coc] : "[" . $coc . "] Unknown";
	if ($coc == "Invalid Country Code"){
		echo "<b><font color=red > ".$_POST['ue']."</font>";
	}else{
		echo "<b><font color=green > ".$cocok." | ".$_POST['ue']."</font>";
                     					$handle = fopen($file, 'a');
						fwrite($handle, $_POST['ue']."<br>");
						fclose($handle);
	}
}else{
	echo "PrivX";
